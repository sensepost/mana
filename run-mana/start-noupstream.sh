...
echo
echo -e "\033[38;5;220m This script will start MANA in no \033[39m"
echo -e "\033[38;5;220m upstream mode (fake internet) with a captive portal \033[39m"
echo -e
echo -e "\033[38;5;220m Useful in places where people often \033[39m"
...
# In order for the captive portal to work, we need to have a number of fake apache virtualhosts
# present. All mobile devices connect to these to ensure Internet connectivity is possible.

echo "${grn}[+]${nc/root/mana/apache/etc/apache2/sites-enabled}Pushing captive portal apache virtual host confs into main apache dir"
service apache2 stop
sleep 5
cp -R /root/mana/apache/etc/apache2/sites-enabled/* /etc/apache2/sites-enabled/
sleep 3
